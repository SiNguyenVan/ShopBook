...
<%
List<Order> orderList = (List<Order>) request.getAttribute("OrderStatusList");
                                   ...
                                   <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>  
                                                <button id="status-accept" value="<%=i.getOrderID()%>" name="status" >Accept </button>
                                                <button id="status-accept" value="<%=i.getOrderID()%>" name="reject" >Reject </button>
                                            </td>
...
<script>
        // L?y nút "Accept" b?ng cách s? d?ng querySelector
        const acceptButton = document.querySelector('#status-accept');

        // Thêm s? ki?n click vào nút và g?i hàm submitFormOnAcceptClick()
        acceptButton.addEventListener('click', submitFormOnAcceptClick);
    </script>
</body>
