...
<%
List<OrderDetails> List = (List<OrderDetails>) request.getAttribute("orderList");
                            ...
                            %>
                              <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="" class="dropdown-item">  <a href="Profile" class="nav-item nav-link active">View Profile</a>
                                     <a href="Tracking" class="dropdown-item">  <a href="Profile" class="nav-item nav-link active">Tracking</a>
                                </div>
                            </div>
...
//User_Info user =(User_Info) request.getSession().getAttribute("account");
  ...
  %>
                                            <td><%=i.getOrder().getOrderID()%></td>
                                            
                                            <td><%=i.getOrder().getOrderDate()%></td>
                                            <td><%=i.getOrder().getShipID().getShipName()%></td>
                                            <td><%=i.getOrder().getShip_address()%></td>
