...
<%
List<Order> orderList = (List<Order>) request.getAttribute("userList");
   ...
   <form  action="Cart" method="post" id="myForm">
                            ...
                            %>
                              <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                     ...
                                     <a href="Profile" class="nav-item nav-link active">View Profile
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Order Status</h1>
            ...
            <div class="col-lg-8 table-responsive mb-5">
                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                          <%
 // List<OrderStatus> orderList = (List<OrderStatus>) request.getAttribute("OrderStatusList");
//User_Info user =(User_Info) request.getSession().getAttribute("account");
  ...
  String a=i.getUserID().getUserID()+"";  
  if(MyuserID.trim().equals(a)) {
   if(i.getStatus().getStatusName().equals("Hold")) {
  %>
                                            ...
                                            <td><%=i.getTotal()%></td>
                                            <td><%=i.getStatus().getStatusName()%></td>
                    </tbody>
                    <%  }
}
}
