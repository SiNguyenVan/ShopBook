...
public class UpdateCategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Instance.getCategoryByCateID(id)==null) {
            response.sendRedirect("Adm");
            return;
        }
        request.setAttribute("listOfCategory", Instance.getAllCategory());
        request.setAttribute("Category", Instance.getCategoryByCateID(id));
        request.getRequestDispatcher("view/FormUpdateCategory.jsp").forward(request, response);
    }
...
//        processRequest(request, response);
    ...
    if(Instance.UpdateCategory(id, op, id_raw)==true){
        response.sendRedirect("Adm");
        return;
    }else {
